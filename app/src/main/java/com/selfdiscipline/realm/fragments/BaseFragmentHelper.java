    ...
    protected void showReward(RewardEngine.RewardResult r) {
        ...
        if (r.realmUp && r.newRealm != null) {
            new AlertDialog.Builder(getActivity())
                    .setTitle(R.string.dialog_realm_up_title)
                    .setMessage(getString(R.string.format_realm_up_message, getString(r.newRealm.nameRes), getString(r.newRealm.descRes)))
